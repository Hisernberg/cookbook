...
| Name | Description | Link |
|------|-------------|------|
| LFM Speech Dataset Studio | Local-first Bangla speech dataset workflow for LFM-Audio capability auditing, BanglaASR baseline analysis, Liquid text repair-potential measurement, abstaining evidence routing, and schema-valid reviewable action cards. | [Code](https://github.com/YOUR_USERNAME/lfm-speech-dataset-studio) |
